local spinner = {
  ...
  rand_hl_group = "CodeCompanionSpinnerHLGroup",
  ns = vim.api.nvim_create_namespace "custom_codecompanion_spinner",
  timer = nil,
}
...
local eldritch_group = vim.api.nvim_create_augroup("CodeCompanionEldritchSpinner", {})

vim.api.nvim_create_autocmd("User", {
  pattern = "CodeCompanionRequestStarted",
  group = eldritch_group,
  callback = function()
    spinner:reset()
